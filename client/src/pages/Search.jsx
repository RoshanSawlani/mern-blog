...
const handleSubmit = (e) =>{
  ...
  return (
    <div className='flex flex-col md:flex-row'>
        ...
        <div className="w-full"><h1 className='text-3xl font-semibold sm:border-b border-gray-500 p-3 mt-5'>Post results:</h1>
        <div className="p-7 flex flex-wrap gap-4">
            {
                !loading && posts.length === 0 && <p className='text-xl text-gray-500'></p>
            }
            {
                loading && (
